...
riot.tag('home', '<div name="content" class="content"> <div class="vision"> You have the <span class="blue">vision.</span> </div> <div class="bricks"> We have the <span class="yellow">bricks.</span> </div> <div class="hookWrapper"> <a href="#form"> <button class="hook btn" type="button" name="button"> Let\'s build a road to <span class="emerald">Oz.</span> </button> </a> </div> </div> <hr> <div class="manifesto"> <h1>Kappa DB</h1> <p> Our flagship product, KappaDB, is a dynamically distributed database platform that has configurable storage engines and leverages a custom, SQL-like query language for data retrieval from its immutable event log backbone. KappaDB allows embedded capabilities such as long running analysis jobs against the database and data is stored in a redundant fashion to protect against data loss while optimizing for speed. </p> <div class="tri"> <span class="tritle"> Simple </span> <div class="ill"> <i class="material-icons">thumb_up</i> </div> <ul> <li>Architecture</li> <li>Query Language</li> <li>Replication Built-in</li> </ul> </div> <div class="tri middle"> <span class="tritle"> Fast </span> <div class="ill"> <i class="material-icons">schedule</i> </div> <ul> <li>Linear Scalability</li> <li>Gentle Learning Curve</li> <li>Binary Protocol</li> </ul> </div> <div class="tri"> <span class="tritle"> Intuitive </span> <div class="ill"> <i class="material-icons">accessibility</i> </div> <ul> <li>UI/UX</li> <li>SQL-like Commands</li> <li>Unidirectional Data Flow</li> </ul> </div> </div> <a id="form"> <hr> </a> <form onsubmit="{ contact }" class="form"> <h1>Contact Us</h1> <div class="formGroup"> <label for="name">Name</label> <input id="name" name="name" required> </div> <div class="formGroup"> <label for="org">Org</label> <input id="org" name="org"> </div> <div class="formGroup"> <label for="email">Email</label> <input id="email" name="email" type="email" required> </div> <div class="formGroup"> <label id="msgLabel" for="msg">Msg</label> <textarea id="msg" name="msg" required></textarea> </div> <div class="formGroup"> <button class="btn"> <span class="formBtnTxt">Send</span> <i class="material-icons">send</i> </button> </div> </form> ', 'home , [riot-tag="home"] { } home .content , [riot-tag="home"] .content { padding: 60px 0; margin-top: 180px; font-size: 3rem; font-family: SansSerifFLF; background-color: white; color: black; text-align: center; } home .content div , [riot-tag="home"] .content div { padding: 30px 0; } home .vision , [riot-tag="home"] .vision { text-align: left; width: 90%; margin-left: 60px; } home .blue , [riot-tag="home"] .blue { color: #7AACF3; font-weight: bold; } home .bricks , [riot-tag="home"] .bricks { width: 100%; text-align: center; } home .yellow , [riot-tag="home"] .yellow { color: #F3AC3E; font-weight: bold; } home .emerald , [riot-tag="home"] .emerald { color: #42BF26; font-weight: bold; } home .hookWrapper , [riot-tag="home"] .hookWrapper { width: 95%; margin-right: 5%; text-align: right; } home .hook , [riot-tag="home"] .hook { font-size: 3rem; text-align: right; font-family: SansSerifFLF; padding: 10px; margin-top: 30px; } home .manifesto , [riot-tag="home"] .manifesto { margin-top: 60px; margin-left: auto; margin-right: auto; background-color: #fff; font-family: SansSerifFLF; } home .manifesto h1 , [riot-tag="home"] .manifesto h1 { padding: 15px 0; text-align: center; background-color: white; font-family: Quango; } home .manifesto p , [riot-tag="home"] .manifesto p { width: 80%; margin-left: 10%; font-size: 1.4rem; } home .tri , [riot-tag="home"] .tri { width: 33%; display: inline-block; background-color: white; color: black; margin: 60px 0; font-family: SansSerifFLF; font-size: 2rem; text-align: center; } home .middle , [riot-tag="home"] .middle { border-left: 1px solid #eee; border-right: 1px solid #eee; } home .tritle , [riot-tag="home"] .tritle { border-bottom: 1px solid gray; padding-bottom: 10px; margin-bottom: 60px; font-family: Quango; } home .ill , [riot-tag="home"] .ill { margin: 30px 0; font-size: 4rem; } home .ill i , [riot-tag="home"] .ill i { font-size: 4rem; } home .tri ul , [riot-tag="home"] .tri ul { text-align: left; margin-top: 30px; list-style-type: none; margin-left: auto; margin-right: auto; } home .tri li , [riot-tag="home"] .tri li { margin-bottom: 20px; } home .form , [riot-tag="home"] .form { padding: 30px; background-color: white; color: black; text-align: center; font-family: SansSerifFLF; } home .form h1 , [riot-tag="home"] .form h1 { margin-top: 30px; margin-bottom: 30px; } home .formGroup , [riot-tag="home"] .formGroup { width: 100%; min-height: 50px; margin: 20px 0; } home label , [riot-tag="home"] label { display: inline-block; width: 10%; height: 30px; text-align: right; margin-right: 10px; position: relative; bottom: 5px; } home #msgLabel , [riot-tag="home"] #msgLabel { bottom: 42px; } home input , [riot-tag="home"] input { display: inline; width: 60%; height: 50px; font-family: SansSerifFLF; font-size: 2rem; line-height: 2.2rem; border: 1px solid gray; } home textarea , [riot-tag="home"] textarea { display: inline; width: 60%; height: 90px; font-family: SansSerifFLF; font-size: 1.4rem; line-height: 1.6rem; } home .btn , [riot-tag="home"] .btn { background-color: #f9f9f9; color: #333; border-top: 1px solid #eee; border-left: 1px solid #eee; border-right: 1px solid #ccc; border-bottom: 1px solid #ccc; } home .btn:active , [riot-tag="home"] .btn:active { background-color: #f1f1f1; border-top: 1px solid #ccc; border-left: 1px solid #ccc; border-right: 1px solid #eee; border-bottom: 1px solid #eee; } home .form i , [riot-tag="home"] .form i { position: relative; top: 7px; left: 5px; } home .form button , [riot-tag="home"] .form button { padding-bottom: 10px; margin-right: 14%; float: right; } }', function(opts) {
