...
riot.tag('logo', '<div class="logo" name="logo"> <span class="logoTxt">Black Label Data</span>  </div>', 'logo , [riot-tag="logo"] { width: 100%; text-align: center; } logo .logo , [riot-tag="logo"] .logo { font-family: "impactLabel"; font-size: 5rem; margin-left: auto; margin-right: auto; } logo .logoBlock , [riot-tag="logo"] .logoBlock { float: left; } logo .space , [riot-tag="logo"] .space { margin-right: 0; } logo .logoTxt , [riot-tag="logo"] .logoTxt { background-color: #fff; } @media all and (max-width: 634px) { logo body , [riot-tag="logo"] body { background: #ccc; } }', function(opts) {
  var self = this;
